...
describe('onSelect prop', function () {
  ...
  test('pressing Enter when one of the suggestion items is active', function () {
    ...
    var mockSuggestion = _testHelpers.mockSuggestions[0];
    mockSuggestion.active = true;

    expect(onSelectHandler).toBeCalledWith(mockSuggestion.description, mockSuggestion.placeId, mockSuggestion);
  });
